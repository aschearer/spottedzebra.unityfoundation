...
namespace SpottedZebra.UnityFoundation.Tasks.Variables
{
    ...
    public sealed class IsStoryBeat : ConditionTask
    {
        ...
        public BBParameter<StoryBeatTest.StoryBeatTestType> Operation = new BBParameter<StoryBeatTest.StoryBeatTestType>(StoryBeatTest.StoryBeatTestType.UnlockedAndUnseen);
